...
var HTMLonlineClassesStart = '<div class="onlineClasses-entry"></div>';//我加的，为了实现盒子模型
...
you to create a function that will need this helper code to run. Don't delete! It hooks up your code to the button you'll be appending.
*/
